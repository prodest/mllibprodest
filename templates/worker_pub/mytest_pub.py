...
def test():
    ...
    2. Esta função não deve receber parâmetros nem retornar nada;
    3. A responsabilidade de criar os testes personalizados e verificar se passaram é do desenvolvedor do modelo;
    4. Imprima na tela ou salve em logs as informações que você achar que são úteis.
    """
